# A program that reads an integer number representing a budget.
...
# it prints "You went in overdraft!" and end the program. Otherwise,
# if you accomplished to buy all products before receiving "End",
